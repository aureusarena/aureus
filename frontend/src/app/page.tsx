      ...
      <footer className="relative z-20 border-t border-white/10 bg-[#1a2eb8]">
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center justify-center gap-5 mt-6">
            <a
              href="https://x.com/aureusarena"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-white/25 hover:bg-white/10 transition-all"
            >
              <svg
              ...
              <span className="text-[10px] tracking-[0.15em] uppercase text-white/50 group-hover:text-white/80 transition-colors font-semibold">
                @aureusarena
              </span>
            </a>
            <a
              href="https://discord.gg/vdCaW9YMSd"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-white/25 hover:bg-white/10 transition-all"
            >
